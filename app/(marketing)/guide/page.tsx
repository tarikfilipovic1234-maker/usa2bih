...
export const metadata: Metadata = {
  ...
  description:
    "Step by step: how importing a car from a US auction to Bosnia and Herzegovina works, from finding a vehicle to delivery.",
};
            ...
            return (
              <li key={step.id} className="relative mb-8 flex gap-6 pl-0">
                ...
                <Card interactive className="flex-1 p-5">
                  ...
                  <h2 className="mt-1 font-display text-lg font-semibold text-chrome">
                    {step.title}
                  </h2>
